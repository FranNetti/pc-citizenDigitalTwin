package it.unibo.stakeholder.view

import it.unibo.stakeholder.controller.{Controller, FailedLogin, LoginResult, SuccessfulLogin, UnsupportedRole}
import it.unibo.stakeholder.model.data.Roles
import it.unibo.stakeholder.model.data.Roles._
import it.unibo.stakeholder.view.View.SwingExecutionContext
import it.unibo.stakeholder.view.frame.{LoginFrame, MedicFrame, PoliceFrame, showDialog}
