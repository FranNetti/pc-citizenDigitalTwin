...
import it.unibo.stakeholder.model.channel.parser.DataRegistryParser.ValueParserMap
import it.unibo.stakeholder.model.channel.parser.ParserLike.Parser
import it.unibo.stakeholder.model.channel.parser.ValueParser.ValueParser
import it.unibo.stakeholder.model.channel.rest.vertx._
import it.unibo.stakeholder.model.data.{GroupCategory, LeafCategory}
