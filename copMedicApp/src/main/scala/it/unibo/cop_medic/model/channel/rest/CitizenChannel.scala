...
import it.unibo.cop_medic.util.FutureService
import it.unibo.cop_medic.util.FutureService._
import it.unibo.cop_medic.model.channel.rest.vertx._
import it.unibo.cop_medic.model.channel.websocket.{CitizenProtocol, Failed, Ok, WebsocketRequest, WebsocketResponse, WebsocketUpdate}
import it.unibo.cop_medic.model.channel.coap._
